...
var stripe = Stripe('pk_test_XAe9Izm74p9zakWOB5DGgXMi00iTFVvNJM');
...
var updateUserFrom = document.querySelector('.form-user-data');
...
if (updateUserFrom) {
  updateUserFrom.addEventListener('submit', function (e) {
    e.preventDefault();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4974" + '/');
